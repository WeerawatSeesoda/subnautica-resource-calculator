...
test:
	...
	g++ -Wall -Wpedantic -std=c++20 -c tests/show.test.cpp -o obj/show.test.o
	g++ obj/libs.o obj/libs.test.o obj/show.o obj/show.test.o -lgtest -lgtest_main -lpthread -o bin/utest
	bin/utest
